...
public class EmbeddingTest {
	...
	public void testEmbeddingModel() {
		Response<Embedding> embed = embeddingModel.embed("你好，我是秋枫");
	...
	public void testUploadKnowledgeLibrary() {
		...
		// 并使用默认的文档解析器对文档进行解析
		Document document1 = FileSystemDocumentLoader.loadDocument(directoryPath + "/医院信息.md");
		Document document2 = FileSystemDocumentLoader.loadDocument(directoryPath + "/科室信息.md");
		Document document3 = FileSystemDocumentLoader.loadDocument(directoryPath + "/神经内科.md");
